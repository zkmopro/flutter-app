...
RustBuffer uniffi_mopro_bindings_fn_func_generate_halo2_proof(RustBuffer srs_path, RustBuffer pk_path, RustBuffer inputs, RustCallStatus *_Nonnull out_status
);
#endif
...
int8_t uniffi_mopro_bindings_fn_func_verify_halo2_proof(RustBuffer srs_path, RustBuffer vk_path, RustBuffer proof_data, RustBuffer public_inputs, RustCallStatus *_Nonnull out_status
);
#endif
